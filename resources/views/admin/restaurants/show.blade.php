...
@section('content')
    <div class="container mx-auto">
        <div class="mt-2">
            <a href="{{ route('admin.restaurant.index') }}" class="btn btn-danger">
                Torna alla tabella
            </a>
        ...
        <div class="card mt-3 mb-3">
            ...
            <div class="row">
                ...
                <div class="col">
                    <img src="{{ $restaurant->image }}" class="card-img-top img-fluid" alt="">
                </div>
                <div class="col p-4 ">
                    <div class="card-head">
                        <div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><strong>Aggiornato il:
                            </strong>{{ $restaurant->updated_at->formatLocalized('%e/%m/%Y') }}</li>
