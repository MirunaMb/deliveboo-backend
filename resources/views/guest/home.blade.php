    ...
    <section class="container content mt-5">
        <div class="table-wrapper p-5">
            <div class="descr-edit text-end">
                ...
                <span> Insieme possiamo aiutarti a raggiungere sempre più clienti!</span>
            </div>
        </div>
   

        <div class="scrollable-content block d-flex flex-wrap justify-content-around">
            
            <div class="logo"> <img class="image-2" src="{{ url('img/images.png') }}" alt=""></div>
            <div class="logo"> <img class="image-3" src="{{ url('img/kfc.jpg') }}" alt=""></div>
